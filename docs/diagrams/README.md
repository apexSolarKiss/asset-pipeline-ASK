...
asset-pipeline-ASK_bounded-generativity.figure.js           bespoke AP figure — derived from method-ASK's bounded-generativity figure @ 2e5d8c4; consumes DS Three Functions (@ 8fb82b7) + shared static exporter (@ 5512b5d); AP surface-adapted geometry under ASK authorization (shared invariant = topology + semantics, not pixel-identical geometry)
asset-pipeline-ASK_bounded-generativity-dark.png            committed full-page render (dark) — theme-responsively embedded in docs/creative-discretion-doctrine-v1.md
asset-pipeline-ASK_bounded-generativity-light.png           committed full-page render (light) — theme-responsively embedded in docs/creative-discretion-doctrine-v1.md
asset-pipeline-ASK_bounded-generativity-diagram-dark.png    committed chrome-free diagram render (dark) via the PNG diagram export
asset-pipeline-ASK_bounded-generativity-diagram-light.png   committed chrome-free diagram render (light) via the PNG diagram export
