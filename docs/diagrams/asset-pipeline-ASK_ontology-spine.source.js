/* asset-pipeline-ASK_ontology-spine.source.js
   ...
   asserted on any node (the engine's default styling carries them as plain
   structural nodes). Do not introduce earned/held/legacy here — that is the
   ...
   is authoritative. Renderable by diagrams-spine-engine.js
   (window.DIAGRAMS.render). Bump the source-v / render-v stamp in the HTML when
