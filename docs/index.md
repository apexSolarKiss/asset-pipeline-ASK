...
- **Continuity-breaking intake test** — would operationally pressure the Scale-of-Operation Held Question framing in [docs/architecture.md](architecture.md) by isolating whether downstream readers can reconstruct enough trace from current carriers without intake-session memory. Pressures Zone 6 (intake-time judgment trace) at intake / governance layer per PR #248. Named in PR #244 Section 9; not authorized.
