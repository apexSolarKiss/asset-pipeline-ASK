...
The active frontier is the IA layered-content redirection: see [docs/ia-layered-content-redirection-note-v1.md](ia-layered-content-redirection-note-v1.md). Phase 1 (on-paper IA layered-content work across the four worked-example modes, plus the cross-mode synthesis) is closed on main. Phase 2 (brand discovery / digestion architecture) is substantively in flight on main. Milestone-8 has marked the plateau and `docs/architecture.md` has been rewritten as the current-architecture front door. Further Airtable prototype mutation remains paused. The older candidate paths described below remain durable possibilities, deferred behind the redirection.
