...
- **Structured IA model v2** — would absorb the stable enumeration the Phase 2 six-category synthesis surfaces (six-category set; relation vocabulary; conditional-jump-point sequence behaviors; five-or-six-zone hybrid implication); operational pressure has not validated the enumeration. Named as a candidate next-pressure surface in PR #244 Section 9; not authorized.
