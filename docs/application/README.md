...
Application-layer grammars for generated-output substrates produced by applying the repository's ontology to a deployment context. These are application-layer artifacts, not architecture front-door doctrine, schema, validator / orchestration, or implementation.
