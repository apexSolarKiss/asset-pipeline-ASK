...
- **Brand-system carrier-decision successor** — would pressure the structural decision against the sharper five-or-six-zone hybrid implication PR #244 surfaces. Named in PR #244 Section 9; not authorized.
- **Continuity-breaking intake test** — would operationally pressure the Scale-of-Operation Held Question framing in [docs/architecture.md](architecture.md) by isolating whether downstream readers can reconstruct enough trace from current carriers without intake-session memory. Named in PR #244 Section 9; not authorized.
- **Application-guidelines cross-touchpoint operational pressure** — marketing-mode full-flow with application-guidelines-shaped intake content would operationally pressure Zone 3 of the five-or-six-zone hybrid implication (per-touchpoint and per-mode constraint structural representation). Named in PR #244 Section 9; not authorized.
- **Past-campaigns temporal-state operational pressure** — campaign-mode cross-campaign continuity test (multi-campaign rather than within-Warm-Restraint-envelope) would operationally pressure Zone 5 (temporal-state trace dimension). Named in PR #244 Section 9; not authorized.
