...
For project state (artifacts, decisions, milestones, current navigation), start from `README.md` and `docs/index.md`, then read the latest milestone in `docs/milestones/`.
